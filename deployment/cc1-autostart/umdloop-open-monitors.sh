#!/bin/bash
# umdloop-open-monitors.sh (CC1)
# Opens two Chrome windows in fullscreen, one per monitor.
...
URLS=(
  "http://localhost:3000/?monitor=slot-1"
  "http://localhost:3000/?monitor=slot-2"
)
